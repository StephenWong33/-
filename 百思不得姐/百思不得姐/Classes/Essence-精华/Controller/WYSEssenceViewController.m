...
@interface WYSEssenceViewController() <UIScrollViewDelegate>
/** 标签栏底部的红色指示器 */
...
@implementation WYSEssenceViewController
...
- (void)setupChildVces
{
    WYSTopicViewController *all = [[WYSTopicViewController alloc] init];
    all.title = @"全部";
...
- (void)setupTitlesView
{
    ...
    titlesView.height = WYSTitilesViewH;
...
- (void)tagClick
{
    WYSRecommendTagsViewController *tags = [[WYSRecommendTagsViewController alloc] init];
