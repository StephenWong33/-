...
- (void)publishClick
{
    WYSPublishViewController *publish = [[WYSPublishViewController alloc] init];
...
{
    // 发出一个通知
    [WYSNoteCenter postNotificationName:WYSTabBarDidSelectNotification object:nil userInfo:nil];
}
